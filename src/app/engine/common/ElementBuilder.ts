    ...
    static setLight(type: string, s: Scene, options?: any): Light {
        switch (type) {
            case LIGHT.DIRECTIONAL:
                return new DirectionalLight("DirectionalLight", new Vector3(1, 10, 1), s);
            case LIGHT.SPOT:
                return new PointLight("SpotLight", new Vector3(1, 10, 1), s);
            case LIGHT.POINT:
                return new PointLight("PointLight", new Vector3(1, 10, 1), s);
            case LIGHT.HEMISPHERIC:
                return new HemisphericLight("HemisphericLight", new Vector3(1, 10, 1), s);
